"""Alembic environment for the app lineage (``app`` schema).

Runs as the app role (owner of the ``app`` schema) and records history in
``app.alembic_version_app``.
"""
...
from mtg_ai.schema import AppBase  # noqa: F401 - import registers app models
from mtg_ai.schema.base import APP_SCHEMA
